...
cursor-pointer px-3 py-2 dark:text-white rounded-lg hover:bg-red-600 hover:text-white"
      ...
      >
        <div>
          {isMenuOpen ? (
            <FaXmark className="☐ text-black dark:text-white text-2x1 cursor-pointer" />
          ) : (
            <FaBars className="text-black dark:text-white text- cursor-pointer" />
          )}
        </div>
      </div>
      <div
        className={`${isMenuOpen ? "flex" : "hidden"} w-full h-fit bg-slate-800
